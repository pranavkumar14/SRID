...
const std::string CLIENT_ID("data_subcribe");
std::string TOPIC ("status/device");
std::string TOPIC1 ("status/subs");
std::string TOPIC2 ("data");
...
int main(int argc, char* argv[])
{
	...
	std::cout << "  ...OK" << std::endl;
		std::cout << "\nConnecting..." << std::endl;
		mqtt::token_ptr conntok = client.connect(connOpts1);
		...
		mqtt::message_ptr pubmsg = mqtt::make_message(TOPIC1, "true");
		pubmsg->set_qos(QOS);
